...
async function validTopShotToken(token) {
  ...
  const queryBody = { operationName: 'GetMyProfile', variables: {}, query: 'query GetMyProfile {\n  getMyProfile {\n    email\n    tradeTicketCount\n    momentCount\n    marketingCampaign\n    publicInfo {\n      dapperID\n      flowAddress\n      username\n      profileImageUrl\n      createdAt\n      favoriteTeamID\n      ownedSpecialNFTTypes\n      __typename\n    }\n    __typename\n  }\n}\n' };
...
async function getTopShotPackInfo(token, packDetails) {
  ...
  try {
    ...
    return { packsWithNoMomentInfo, momentIdWithPackDetails };
  } catch (e) {
    console.log(e);
    return false;
  }
